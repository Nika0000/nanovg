...
#define NVG_VERSION_PATCH 3        // x-release-please-patch
#define NVG_VERSION_STRING "0.10.3" // x-release-please-version
...
// Can be one of NVG_LINE_SOLID (default), NVG_LINE_GLOW, NVG_LINE_DASHED, NVG_LINE_DOTTED
