...
fxc.exe /Fh D3D11BlurVertexShader.h /T vs_5_0 /E D3D11BlurVertexShader_Main D3D11BlurVertexShader.hlsl
fxc.exe /Fh D3D11BlurPixelShader.h /T ps_5_0 /E D3D11BlurPixelShader_Main D3D11BlurPixelShader.hlsl
